...
// TODO: remove this function, use the one provided by Dmytro (src/js/news-cards.js). This is temporary fake function. Change function name to make clear what it does, f.e. function createNewsCardMarkUp.

function createMarkup({ abstract, title, updated, nytdsection, url, media }) {
    let mediaUrl = '../../images/defaultImg.jpg';
    // TODO: Resolve media format issue later. 
    // if (media[0]) {
